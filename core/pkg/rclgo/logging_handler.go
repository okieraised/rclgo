...
// Backward compatibility is not guaranteed for this type alias. Use it only if
// necessary.
...
// which logs messages based on ROS parameters used to initialize the logging system.
